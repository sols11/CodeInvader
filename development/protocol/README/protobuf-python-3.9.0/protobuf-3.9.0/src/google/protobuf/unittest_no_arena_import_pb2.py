...
# source: unittest_no_arena_import.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='unittest_no_arena_import.proto',
  package='proto2_arena_unittest',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n\x1eunittest_no_arena_import.proto\x12\x15proto2_arena_unittest\"\'\n\x1aImportNoArenaNestedMessage\x12\t\n\x01\x64\x18\x01 \x01(\x05')
)
...
ImportNoArenaNestedMessage = _reflection.GeneratedProtocolMessageType('ImportNoArenaNestedMessage', (_message.Message,), {
  ...
  '__module__' : 'unittest_no_arena_import_pb2'
