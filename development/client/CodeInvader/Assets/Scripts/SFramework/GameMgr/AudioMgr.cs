...
namespace SFramework
{
    ...
    {
        private SettingData Setting { get; set; }    // 只用于获取数据，不进行写入
        ...
        public AudioMgr(GameMgr gameMgr) : base(gameMgr)
        {
        ...
        {
            Setting = gameMgr.fileMgr.Setting;
            // 实例化设置
            if (gameObject == null)
            {
                ...
                musicAudioSource.volume = Setting.MusicVolume / 100.0f;   
                Object.DontDestroyOnLoad(gameObject);
            }
            // 添加音乐
            musicPathList.Add("Corruption");
            Debug.Log("音乐列表确认完毕");
        }
        ...
        public void AddSound(AudioSource sound)
        {
            ...
            sound.volume = Setting.SoundVolume / 100.0f;
        }
        ...
        {
            musicAudioSource.clip = gameMgr.resourcesMgr.LoadResource<AudioClip>(musicResouceDir + musicPathList[index], false);
        ...
        public void ChangeMusicVolume(int volume)
        {
            ...
            musicAudioSource.volume = volume/100.0f;  
        }
